...
- The function signature becomes the **tool schema**
- MCP automatically exposes:
  - Tool name
  - Parameters
  - Return type
  - Docstring as tool description

✅ **This is the most important MCP idea**  
> Any normal Python function becomes an LLM‑callable tool just by decorating it.
